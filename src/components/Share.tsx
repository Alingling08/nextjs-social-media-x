  ...
  return (
    <form className="p-4 flex gap-4" action={(formData) => shareAction(formData, settings)}>
      ...
      <div className="relative w-10 h-10 rounded-full overflow-hidden">
        <ImageComponent src="general/avatar.png" alt="" w={150} h={150} tr={true} />
      </div>
      {/* OTHERS */}
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex gap-4 flex-wrap">
            ...
            <label htmlFor="file">
              <ImageComponent src="icons/image.svg" alt="" w={20} h={20} className="cursor-pointer" />
            </label>
            <ImageComponent src="icons/gif.svg" alt="" w={20} h={20} className="cursor-pointer" />
            <ImageComponent src="icons/poll.svg" alt="" w={20} h={20} className="cursor-pointer" />
            <ImageComponent src="icons/emoji.svg" alt="" w={20} h={20} className="cursor-pointer" />
            <ImageComponent src="icons/schedule.svg" alt="" w={20} h={20} className="cursor-pointer" />
            <ImageComponent src="icons/location.svg" alt="" w={20} h={20} className="cursor-pointer" />
          </div>
